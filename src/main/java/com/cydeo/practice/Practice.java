...
public class Practice {
    ...
    //Display all the employee's first name
    ...
    //Display all the countries name
    ...
    //Display all the department's manager's first name
    ...
    //Display all the department where manager name of department is 'Steven'
    ...
    //Display the regions of the IT department
...
//                .findFirst().get().getLocation().getCountry().getRegion();
    ...
    //Display all the departments where the region of departments is 'Europe'
    ...
    //Check if the salaries of all the employees in IT department are greater than 2000 (department : IT)
    ...
    public static Long getMaxSalaryInAmericasRegion() throws Exception {
        return employeeService.readAll().stream()
                ...
                .max(Comparator.comparing(Employee::getSalary))
                .orElseThrow(() -> new RuntimeException("Something went wrong!")).getSalary();
    }
